...
type ProviderTemplateValidation func(*ProviderTemplate) error
...
func (c *Capabilities) ValidateProviderTemplate(channel, provider string, value *ProviderTemplate) error {
	if value == nil {
		return nil
	}
	if c == nil {
